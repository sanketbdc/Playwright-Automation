...
const SUITE_CONFIG = {
  camel: {
    ...
    text:     'Please find attached the Camel login test execution report (Excel).\nThe full HTML report is available as an artifact in GitHub Actions.',
  },
  geg: {
    subject:  'Playwright Execution Report — GEG Enquiry Form',
    excelDir: path.join(__dirname, 'reports', 'geg'),
    text:     'Please find attached the GEG Enquiry Form test execution report (Excel).\nThe full HTML report is available as an artifact in GitHub Actions.',
  },
  rustomjee: {
    subject:  'Playwright Execution Report — Rustomjee',
    excelDir: path.join(__dirname, 'reports', 'rustomjee'),
    text:     'Please find attached the Rustomjee test execution report (Excel).\nThe full HTML report is available as an artifact in GitHub Actions.',
  },
};
...
async function sendMail() {
  ...
  // ── Excel report only (HTML zip excluded — too large / blocked by Gmail) ──
